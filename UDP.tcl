...
#
# Generated by Vivado on Thu Jun 19 14:25:15 +0200 2025
...
#    "C:/Users/lima/Desktop/Backup/UDP-Sandbox/UDP/UDP.srcs/sources_1/new/UDP.vhd"
...
set files [list \
 ...
 [file normalize "${origin_dir}/UDP.srcs/sources_1/new/UDP.vhd" ]\
...
if { [get_files UDP.vhd] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/lima/Desktop/Backup/UDP-Sandbox/UDP/UDP.srcs/sources_1/new/UDP.vhd
}
...
# IP, UDP, ethernet_generator
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_PROBE_OUT10_INIT_VAL {0x0000} \
   CONFIG.C_PROBE_OUT10_WIDTH {16} \
   CONFIG.C_PROBE_OUT11_INIT_VAL {0x48656C6C6F20576F726C64000000000000000000} \
   CONFIG.C_PROBE_OUT11_WIDTH {160} \
   CONFIG.C_PROBE_OUT2_INIT_VAL {0xC0A80109} \
   CONFIG.C_PROBE_OUT2_WIDTH {32} \
   CONFIG.C_PROBE_OUT3_INIT_VAL {0xC0A80101} \
   ...
   CONFIG.C_PROBE_OUT7_INIT_VAL {0x04D2} \
   CONFIG.C_PROBE_OUT7_WIDTH {16} \
   CONFIG.C_PROBE_OUT8_INIT_VAL {0x1678} \
   CONFIG.C_PROBE_OUT8_WIDTH {16} \
   CONFIG.C_PROBE_OUT9_INIT_VAL {0x000B} \
   CONFIG.C_PROBE_OUT9_WIDTH {16} \
 ] $vio_0

  # Create port connections
  connect_bd_net -net IP_0_busIP [get_bd_pins IP_0/data_out] [get_bd_pins ethernet_generator_0/data_in]
  connect_bd_net -net IP_0_prtcl_en [get_bd_pins IP_0/prtcl_en] [get_bd_pins UDP_0/en]
  connect_bd_net -net IP_0_start [get_bd_pins IP_0/on_off] [get_bd_pins ethernet_generator_0/prtcl_on_off]
  connect_bd_net -net IP_0_state_dbg [get_bd_pins IP_0/state_dbg] [get_bd_pins ila_0/probe17]
  connect_bd_net -net IP_0_valid [get_bd_pins IP_0/valid] [get_bd_pins ethernet_generator_0/prtcl_valid]
  connect_bd_net -net UDP_0_data_out [get_bd_pins IP_0/data_in] [get_bd_pins UDP_0/data_out]
  connect_bd_net -net UDP_0_on_off [get_bd_pins IP_0/prtcl_on_off] [get_bd_pins UDP_0/on_off]
  connect_bd_net -net UDP_0_valid [get_bd_pins IP_0/prtcl_valid] [get_bd_pins UDP_0/valid]
  ...
  connect_bd_net -net vio_0_probe_out7 [get_bd_pins UDP_0/src_port] [get_bd_pins vio_0/probe_out7]
  connect_bd_net -net vio_0_probe_out8 [get_bd_pins UDP_0/dst_port] [get_bd_pins vio_0/probe_out8]
  connect_bd_net -net vio_0_probe_out9 [get_bd_pins IP_0/data_length] [get_bd_pins UDP_0/data_length] [get_bd_pins vio_0/probe_out9]
  connect_bd_net -net vio_0_probe_out10 [get_bd_pins UDP_0/chcksum] [get_bd_pins vio_0/probe_out10]
  connect_bd_net -net vio_0_probe_out11 [get_bd_pins UDP_0/data_in] [get_bd_pins vio_0/probe_out11]
...
#  -string -flagsOSRD
preplace port CLK_125MHz_0 -pg 1 -lvl 7 -x 2450 -y 1020 -defaultsOSRD
preplace port clk_in1_n_0 -pg 1 -lvl 0 -x -120 -y 1040 -defaultsOSRD
preplace port clk_in1_p_0 -pg 1 -lvl 0 -x -120 -y 1060 -defaultsOSRD
preplace port rgmii_rx_ctl_0 -pg 1 -lvl 0 -x -120 -y 40 -defaultsOSRD
preplace port rgmii_rxc_0 -pg 1 -lvl 0 -x -120 -y 60 -defaultsOSRD
preplace port rgmii_tx_ctl_0 -pg 1 -lvl 7 -x 2450 -y 220 -defaultsOSRD
preplace port rgmii_txc_0 -pg 1 -lvl 7 -x 2450 -y 240 -defaultsOSRD
preplace portBus rgmii_rxd_0 -pg 1 -lvl 0 -x -120 -y 20 -defaultsOSRD
preplace portBus rgmii_txd_0 -pg 1 -lvl 7 -x 2450 -y 200 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 4 -x 1370 -y 590 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 5 -x 1830 -y 1050 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 6 -x 2330 -y 800 -defaultsOSRD
preplace inst tri_mode_ethernet_mac_0 -pg 1 -lvl 5 -x 1830 -y 360 -defaultsOSRD
preplace inst vio_0 -pg 1 -lvl 1 -x 120 -y 560 -defaultsOSRD
preplace inst ethernet_generator_0 -pg 1 -lvl 3 -x 960 -y 580 -defaultsOSRD
preplace inst IP_0 -pg 1 -lvl 2 -x 570 -y 490 -defaultsOSRD
preplace inst UDP_0 -pg 1 -lvl 1 -x 120 -y 200 -defaultsOSRD
preplace netloc IP_0_busIP 1 2 1 740 450n
preplace netloc IP_0_start 1 2 1 770 470n
preplace netloc axis_data_fifo_0_axis_wr_data_count 1 4 2 1550J 660 2120
preplace netloc axis_data_fifo_0_m_axis_tdata 1 4 2 1550 10 2210
preplace netloc axis_data_fifo_0_m_axis_tlast 1 4 2 1580 680 2180
preplace netloc axis_data_fifo_0_m_axis_tvalid 1 4 2 1610 690 2100
preplace netloc axis_data_fifo_0_s_axis_tready 1 3 3 1170 710 NJ 710 2090
...
preplace netloc clk_wiz_0_CLK_125MHz 1 0 7 -100 350 410 350 800 440 1180 440 1600 60 2060 1040 2420J
preplace netloc ethernet_generator_0_count 1 3 3 1140 720 1560 730 2170
preplace netloc ethernet_generator_0_enIP 1 1 3 420 290 N 290 1110
preplace netloc ethernet_generator_0_tdata 1 3 3 1160 750 NJ 750 2070
preplace netloc ethernet_generator_0_tlast 1 3 3 1150 760 NJ 760 2130J
preplace netloc ethernet_generator_0_tvalid 1 3 3 1120 770 NJ 770 2190J
preplace netloc rgmii_rx_ctl_0_1 1 0 6 NJ 40 NJ 40 NJ 40 NJ 40 NJ 40 2040
preplace netloc rgmii_rxc_0_1 1 0 6 NJ 60 420J 50 NJ 50 NJ 50 NJ 50 2030
preplace netloc rgmii_rxd_0_1 1 0 6 NJ 20 NJ 20 NJ 20 NJ 20 NJ 20 2050
...
preplace netloc tri_mode_ethernet_mac_0_tx_axis_mac_tready 1 4 2 1570 700 2050J
preplace netloc tri_mode_ethernet_mac_0_tx_enable 1 5 1 2080 540n
preplace netloc tri_mode_ethernet_mac_0_tx_mac_aclk 1 5 1 2200 500n
preplace netloc tri_mode_ethernet_mac_0_tx_reset 1 5 1 2150 520n
preplace netloc tri_mode_ethernet_mac_0_tx_statistics_vector 1 5 1 2160 340n
preplace netloc vio_0_probe_out0 1 0 6 -80 340 360 340 760 720 1110 730 1590 720 2140J
preplace netloc vio_0_probe_out1 1 1 4 370J 300 NJ 300 NJ 300 1560
preplace netloc vio_0_probe_out2 1 1 1 360 490n
preplace netloc vio_0_probe_out3 1 1 1 340 510n
preplace netloc vio_0_probe_out4 1 1 2 310 320 790J
preplace netloc vio_0_probe_out5 1 1 2 330 330 780J
preplace netloc vio_0_probe_out6 1 1 2 370 630 NJ
preplace netloc IP_0_valid 1 2 1 750 490n
preplace netloc ethernet_generator_0_state_dbg 1 3 3 1130 740 NJ 740 2030J
preplace netloc IP_0_state_dbg 1 2 4 730J 30 NJ 30 NJ 30 2110
preplace netloc IP_0_prtcl_en 1 0 3 -50 330 320J 310 720
preplace netloc UDP_0_data_out 1 1 1 380 170n
preplace netloc UDP_0_valid 1 1 1 400 190n
preplace netloc UDP_0_on_off 1 1 1 390 210n
preplace netloc vio_0_probe_out7 1 0 2 -60 70 270
preplace netloc vio_0_probe_out8 1 0 2 -90 50 300
preplace netloc vio_0_probe_out9 1 0 2 -70 380 350
preplace netloc vio_0_probe_out10 1 0 2 -40 360 290
preplace netloc vio_0_probe_out11 1 0 2 -60 390 280
levelinfo -pg 1 -120 120 570 960 1370 1830 2330 2450
pagesize -pg 1 -db -bbox -sgen -280 -10 2610 1140
"
}
